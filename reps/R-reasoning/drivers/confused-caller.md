...
description: "Confused/hesitant voice persona — serves the core bank rows routed to it (ambiguous-intent, slot-fill). Condition-free shell: all probe behavior comes from the row's persona + guidance."
